		...
		<Layout>
			<div className="home">
				...
				<div className="second-block">
					<img src="/images/womanSmilingHair.jpg" alt="a woman getting her hair cut smiling" />
					<WhiteBlock
				...
				<img className="large-bg-logo" src="/images/HumbleHairdressersLogoLight.png" />


				<h2 className="banner-text">
					When you change how people see themselves, it changes how others see them, too.
				</h2>

			<div className="bottom-block">
				<img src="/images/groupSmiling.jpg" alt="group of hair stylists and people getting hair cut" />
				<DonationsBlock/>
			</div>
